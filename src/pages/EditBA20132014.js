...
const EditBA20132014 = () => {
    ...
    const [currentFigure, setCurrentFigure] = useState('');
     ...
     //INITIALIZE STORES
    const updateFigure = useBA20132014Store((state) => state.updateFigure)
    const deleteFigure = useBA20132014Store((state) => state.deleteFigure)
            ...
            <Container>
                ...
                <Col>
                    <div style={{marginTop: 20, marginBottom: 20, display: 'flex', flexDirection: 'row'}}>
                        <Button style={{marginRight: 20, backgroundColor: '#141D26', borderColor: '#141D26'}} onClick={() => navigate('/addBA20132014')}>
