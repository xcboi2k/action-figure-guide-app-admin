...
const EditBA20142015 = () => {
    ...
    const [currentFigure, setCurrentFigure] = useState('');
     ...
     //INITIALIZE STORES
    const updateFigure = useBA20142015Store((state) => state.updateFigure)
    const deleteFigure = useBA20142015Store((state) => state.deleteFigure)
            ...
            <Container>
                ...
                <Col>
                    <div style={{marginTop: 20, marginBottom: 20, display: 'flex', flexDirection: 'row'}}>
                        <Button style={{marginRight: 20, backgroundColor: '#141D26', borderColor: '#141D26'}} onClick={() => navigate('/addBA20142015')}>
