...
const EditMU20152017 = () => {
    ...
    const [currentFigure, setCurrentFigure] = useState('');
     ...
     //INITIALIZE STORES
    const updateFigure = useMU20152017Store((state) => state.updateFigure)
    const deleteFigure = useMU20152017Store((state) => state.deleteFigure)
            ...
            <Container>
                ...
                <Col>
                    <div style={{marginTop: 20, marginBottom: 20, display: 'flex', flexDirection: 'row'}}>
                        <Button style={{marginRight: 20, backgroundColor: '#141D26', borderColor: '#141D26'}} onClick={() => navigate('/addMU20152017')}>
