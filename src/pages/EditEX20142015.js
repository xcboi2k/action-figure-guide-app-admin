...
const EditEX20142015 = () => {
    ...
    const [currentFigure, setCurrentFigure] = useState('');
     ...
     //INITIALIZE STORES
    const updateFigure = useEX20142015Store((state) => state.updateFigure)
    const deleteFigure = useEX20142015Store((state) => state.deleteFigure)
